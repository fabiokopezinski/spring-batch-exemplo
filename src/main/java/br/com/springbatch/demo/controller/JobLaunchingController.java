package br.com.springbatch.demo.controller;
...
import br.com.springbatch.demo.model.JobLaunchRequest;
...
public class JobLaunchingController {
  ...
  public ExitStatus runJob(@RequestBody JobLaunchRequest request) throws Exception {
    ...
    return this.jobLauncher.run(job, jobParameters).getExitStatus().addExitDescription("JOB TESTE");
  }
}
